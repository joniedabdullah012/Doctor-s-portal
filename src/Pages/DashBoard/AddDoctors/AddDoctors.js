...
const AddDoctors = () => {
    ...
    const { data: specialties, isLoading } = useQuery({
        queryKey: ['specialty'],
        queryFn: async () => {
            const res = await fetch('https://doctors-portal-server-silk-xi.vercel.app/appointmentSpecialty')
        ...
        fetch(url, {
            ...
            .then(imgData => {
                if (imgData.success) {
                    ...
                    fetch('https://doctors-portal-server-silk-xi.vercel.app/doctors', {
                        method: 'POST',
                        headers: {
    ...
    return (
        <div className='w-96 p-7'>
            <h2 className="text-4xl">Add a doctors</h2>
            ...
            <form onSubmit={handleSubmit(handleAddDoctors)}>
                ...
                <div className="form-control w-full max-w-xs">
                    <label className="label">
                        <span className="label-text">Speciallyity</span>
